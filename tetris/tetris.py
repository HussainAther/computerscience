...
class Shape():
    ...
    def can_move(self, board, dx, dy):
        ...
        """
        for block in self.blocks:
            if not block.can_move(self, dx, dy):
                return False
        return True
    ...
    def can_rotate(self, board):
        ...
        dir = board.get_rotation_dir(self)
...
class Board():
    ...
    def draw_shape(self, shape):
        """ Parameters: shape - type: Shape
            ...
            Draw the shape on the board if there is space for it
    ...
    def can_move(self, x, y):
        ...
        if self.x > self.width or self.y > self.height:
            return False
        elif (x,y) in block for block in Shape.get_blocks():
            return False
        return True
